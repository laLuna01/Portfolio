...
export function DesktopScene({ name, role, scene, accessibility }) {
  return (
    <section
    ...
    >
      ...
      >
        <p className="m-0 font-mono text-sm text-[var(--muted)]">{scene.statusMessage}</p>
      </WindowFrame>
    </section>
  );
}
